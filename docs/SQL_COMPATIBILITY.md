...
INSERT, UPDATE and DELETE are applied to the Access file layer and the mirror is
refreshed after successful writes. CREATE/DROP TABLE and INDEX are supported for
